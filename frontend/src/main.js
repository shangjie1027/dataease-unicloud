...
function createDomElement() {
  // debugger
  let el = document.getElementById('bide');

  if (!el) {
    el = document.createElement('div');
    el.id = 'bide';
    el.class = 'bide';
    document.body.querySelector('#MONO_CONTENT').appendChild(el);
  }
  return el;
}
console.log(unmount)
// export function bootstrap (props) {
//   console.log('bide bootstrap')
//   return vueLifecycle.bootstrap(() => {})
// }
 
// export function mount (props) {
//   console.log('bide mount')
//   return vueLifecycle.mount(() => {})
// }
 
// export function unmount (props) {
//   console.log('bide unmount')
