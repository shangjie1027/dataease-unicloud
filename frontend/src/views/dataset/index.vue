<template>
  <de-container v-loading="$store.getters.loadingMap[$store.getters.currentPath]" style="padding-top:10px;"> 

    <de-aside-container type="dataset" style="margin-left:10px;">
